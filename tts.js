...
function submitString(concat, tipe, tabel) {
    ...
    } else if (concat.toUpperCase() == "sql" && tipe == "m1") {
        pengulanganTabel(tabel);
        showMessage("Jawaban Anda Benar");
    } else if (concat.toUpperCase() == "java" && tipe == "d2") {
        pengulanganTabel(tabel);
        showMessage("Jawaban Anda Benar");
    } else if (concat.toUpperCase() == "laravel" && tipe == "d3") {
        pengulanganTabel(tabel);
        showMessage("Jawaban Anda Benar");
    } else if (concat.toUpperCase() == "hash" && tipe == "m2") {
        pengulanganTabel(tabel);
        showMessage("Jawaban Anda Benar");
    } else if (concat.toUpperCase() == "jsp" && tipe == "m3") {
        pengulanganTabel(tabel);
        showMessage("Jawaban Anda Benar");
    } else if (concat.toUpperCase() == "phyton" && tipe == "d4") {
        pengulanganTabel(tabel);
        showMessage("Jawaban Anda Benar");
    } else if (concat.toUpperCase() == "php" && tipe == "m4") {
        pengulanganTabel(tabel);
        showMessage("Jawaban Anda Benar");
    } else {
        showMessage("Jawaban Anda Salah");
    }
}
